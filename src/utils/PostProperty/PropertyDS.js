    ...
    // TODO: Mark Location
    {
        ...
        questions: [
            ...
            },
            {
                ...
                key: "mark_loc_state",
                options: [
                    { displayText: "Andaman & Nicobar Islands" },
                    { displayText: "Andhra Pradesh" },
                    { displayText: "Arunachal Pradesh" },
                    { displayText: "Assam" },
                    { displayText: "Bihar" },
                    { displayText: "Chandigarh" },
                    { displayText: "Chhattisgarh" },
                    { displayText: "Dadra and Nagar Haveli" },
                    { displayText: "Daman and Diu" },
                    { displayText: "Goa" },
                    { displayText: "Gujrat" },
                    { displayText: "Haryana" },
                    { displayText: "Himachal Pradesh" },
                    { displayText: "Jammu and Kashmir" },
                    { displayText: "Jharkhand" },
                    { displayText: "Karnataka" },
                    { displayText: "Kerela" },
                    { displayText: "Lakshadweep" },
                    ...
                    { displayText: "NCT of Delhi" },
                    { displayText: "Odisha" },
                    { displayText: "Puducherry" },
                    { displayText: "Punjab" },
...
export const conditions = {
    ...
    $office_space_share: {
        $and: [
            ...
            {
                $or: [{ pro_type: "Office Space (Time-Share)" }, { pro_type: "Office Space (SEZ)" }],
            },
        ],
    },
    $not_agro_pg_indus: {
    ...
    $pro_category_resi_resiProj: {
        $or: [{ pro_category: "Residential" }, { pro_category: "Residential Project" }],
    },
    ...
    $transc_BSRL: {
        $or: [{ pro_trans_type: "Rental" }, { pro_trans_type: "BuySell" }, { pro_trans_type: "Lease" }],
    },
    $comm_shop: {
        $or: [
            {
    ...
    $commr_commrProj: {
        $or: [{ pro_category: "Commercial" }, { pro_category: "Commercial Project" }],
    },
    $industrial: {
    ...
    $sbua_bua_mm: {
        $and: [
            ...
            { $pre: "$transc_BSRL" },
            {
                $or: [{ pro_category: "Residential Project" }, { pro_category: "Commercial Project" }],
            },
            {
                $or: [
                    {
    ...
    $room_bath_config: {
        $and: [{ $pre: "$pro_category_resi_resiProj" }, { $pre: "$prop_type_home_apart" }],
    },
    $bath_config: {
        $pre: "$pro_category_resi_resiProj",
    },
    ...
    $template: {
        $and: [
            // * User Type
            {
                $or: [{ user_group: "Owner" }, { user_group: "Agent" }, { user_group: "Builder" }],
            },
            // * Transaction Type
            {
                $or: [
    ...
    $area_sqft: {
        $and: [
            ...
            {
                $or: [{ $pre: "$pro_category_resi_resiProj" }, { pro_category: "Commercial" }],
            },
            // * Prop Type Name
            {
                $or: [
    ...
    $oa_resi_resiProj_houseApart: {
        $and: [
            ...
            // * Transaction Type
            {
                $or: [{ pro_trans_type: "Rental" }, { pro_trans_type: "Buy Sell" }, { pro_trans_type: "Lease" }],
            },
            // * Prop Categpry
    ...
    $sbupa_bua: {
        $and: [
            ...
            {
                $or: [{ $pre: "$prop_type_home_apart" }, { pro_type: "Office Space" }, { $pre: "$comm_shop" }],
            },
        ],
    },
    ...
    $area_range: {
        $and: [
            ...
            {
                $or: [{ pro_type: "Residential Land" }, { pro_type: "Commercial Land" }, { $pre: "$holiday_homes" }],
            },
        ],
    },
    $ca_range: {
    ...
    bhk1_cfg: {
        ...
        questions: [
...

            {
                ...
                options: [{ displayText: "Wooden" }, { displayText: "Marble" }, { displayText: "Granite" }],
            },
        ],
    },
    bhk2_cfg: {
